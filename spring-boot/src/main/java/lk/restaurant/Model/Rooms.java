...
public class Rooms {
    ...
    public Rooms(String fName, String lName, int guestNo, int confNo, int guestStatus, String roomNo, int noAdult, int isTax, String pakage, int resNo, int noChild, int exBedAdult, String marketCate) {
        this.fName = fName;
        this.lName = lName;
