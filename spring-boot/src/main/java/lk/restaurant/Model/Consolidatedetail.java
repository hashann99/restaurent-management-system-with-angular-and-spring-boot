...
public class Consolidatedetail {
    ...
    public Consolidatedetail(Integer id, Integer kot_no, String rst_name, String f_name, Date payment_date, Integer item_no, Integer item_code, Integer qty, Double unit_prices, Double ttlvalue, Integer family_gno, Double service_charge, Double tax, Double item_discount) {
        this.id = id;
        Kot_no = kot_no;
